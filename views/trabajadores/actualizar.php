...
'observaciones_familiares' => trim($_POST['observaciones_familiares'] ?? '') ?: null,        'correo_personal' => limpiar($_POST['correo_personal'] ?? ''),
...
// DOTACIÓN (TALLAS)
// ═══════════════════════════════════════
'talla_camisa'   => limpiar($_POST['talla_camisa'] ?? '') ?: null,
'talla_pantalon' => limpiar($_POST['talla_pantalon'] ?? '') ?: null,
'talla_botas'    => limpiar($_POST['talla_botas'] ?? '') ?: null,
