  ...
  <div class="modal">
    <div class="modal-head">
      <div class="modal-head-left">
        <div class="modal-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg></div>
        <div><div class="modal-title">Nuevo Trabajador</div><div class="modal-sub">Completa la informaci&#243;n del nuevo integrante</div></div>
      </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group"><label class="form-label">Nombres</label><input class="form-input" type="text" name="nombres" placeholder="Ej. Mar&#237;a Alejandra" required/></div>
        <div class="form-group"><label class="form-label">Apellidos</label><input class="form-input" type="text" name="apellidos" placeholder="Ej. Torres Garc&#237;a" required/></div>
      </div>
      <div class="form-row">
        <div class="form-group"><label class="form-label">Tipo de documento</label>
          <select class="form-select" name="tipo_documento"><option>C&#233;dula de ciudadan&#237;a</option><option>C&#233;dula de extranjer&#237;a</option><option>Pasaporte</option></select>
        </div>
        <div class="form-group"><label class="form-label">N&#250;mero de documento</label><input class="form-input" type="text" name="numero_documento" placeholder="Ej. 1.234.567.890" required/></div>
      </div>
      <div class="form-row">
        <div class="form-group"><label class="form-label">G&#233;nero</label>
          <select class="form-select" name="genero"><option value="M">Masculino</option><option value="F">Femenino</option><option value="O">Otro</option></select>
        </div>
        <div class="form-group"><label class="form-label">Fecha de nacimiento</label><input class="form-input" type="date" name="fecha_nacimiento"/></div>
      </div>
      <div class="form-section" style="margin-top:6px">Informaci&#243;n de contacto</div>
      <div class="form-row">
        <div class="form-group"><label class="form-label">Correo electr&#243;nico</label><input class="form-input" type="email" name="correo_personal" placeholder="correo@empresa.com"/></div>
        <div class="form-group"><label class="form-label">Tel&#233;fono</label><input class="form-input" type="tel" name="telefono" placeholder="300 000 0000"/></div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group"><label class="form-label">&#193;rea</label>
          <select class="form-select" name="area"><option value="">Seleccionar...</option><option>Producci&#243;n</option><option>Administrativa</option><option>Log&#237;stica</option><option>Mantenimiento</option><option>SST</option></select>
        </div>
        <div class="form-group"><label class="form-label">Cargo</label><input class="form-input" type="text" name="cargo" placeholder="Ej. Operario de Planta"/></div>
      </div>
      <div class="form-row">
        <div class="form-group"><label class="form-label">Fecha de ingreso</label><input class="form-input" type="date" name="fecha_ingreso"/></div>
        <div class="form-group"><label class="form-label">Tipo de contrato</label>
          <select class="form-select" name="tipo_contrato"><option>Indefinido</option><option>Fijo</option><option>Por obra</option><option>Aprendizaje</option></select>
        </div>
      </div>
    </div>
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-head">
    ...
    <div>
      ...
      <div class="sidebar-tag">Transformamos plástico, construimos futuro</div>
    </div>
  </div>
  ...
  <div class="filters-bar">
    <div class="filter-group" style="flex:1;min-width:200px">
      ...
      <div class="search-wrap">
        <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        <input type="text" name="buscar" value="<?php echo htmlspecialchars($buscar)?>" placeholder="Buscar por nombre, documento o correo..."/>
      </div>
    </div>
    <div class="filter-group">
      ...
      <select class="filter-select" name="area">
        ...
        <?php foreach(['Producci&#243;n','Administrativa','Log&#237;stica','Mantenimiento','SST'] as $a): ?>
        <option value="<?php echo $a?>" <?php echo $area===$a?'selected':''?>><?php echo $a?></option>
        <?php endforeach; ?>
      </select>
    </div>
    <div class="filter-group">
    ...
    <div class="filter-group" style="justify-content:flex-end">
      ...
      <div style="display:flex;gap:8px">
        <button type="submit" class="btn-filter"><svg viewBox="0 0 24 24"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>Filtrar</button>
        <?php if($buscar||$area||$estado): ?><a href="index.php" class="btn-filter btn-clear" style="text-decoration:none"><svg viewBox="0 0 24 24"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>Limpiar</a><?php endif; ?>
      </div>
    </div>
  </div>
  </form>
