...
<title>PlastyPetco · Acceso</title>
...
:root{
  ...
  --text-muted:#7bb891;
  --text-dim:#3d6b4a;
  --border:rgba(45,223,110,0.14);
  --border-strong:rgba(45,223,110,0.32);
  --card-bg:rgba(6,18,9,0.82);
  --radius:18px;
}
...
/* big organic shape bg */
.left::before{
  content:'';
  position:absolute;
  top:-20%;left:-10%;
  width:70%;height:80%;
  background:radial-gradient(ellipse,rgba(45,223,110,0.07) 0%,transparent 70%);
  border-radius:50%;
  pointer-events:none;
}
...
.logo-mark svg{
  ...
  filter:drop-shadow(0 0 12px rgba(45,223,110,0.6));
}
...
.feat-pill{
  ...
  align-items:center;
  gap:7px;
  background:rgba(45,223,110,0.06);
  border:1px solid var(--border);
  border-radius:40px;
  padding:7px 14px;
  font-size:12.5px;
...
.feat-pill:hover{border-color:var(--border-strong);color:var(--green-pale)}
...
.right::before{
  ...
  width:1px;
  background:linear-gradient(to bottom,transparent,var(--border) 30%,var(--border-strong) 50%,var(--border) 70%,transparent);
  pointer-events:none;
}
...
.card{
  ...
  box-shadow:
    0 0 0 1px rgba(45,223,110,0.04),
    0 40px 100px rgba(0,0,0,0.6),
    inset 0 1px 0 rgba(255,255,255,0.04);
  animation:cardIn .9s .1s cubic-bezier(.22,1,.36,1) both;
  position:relative;
  overflow:hidden;
}
...
.card::before{
  ...
  background:radial-gradient(circle,rgba(45,223,110,0.1) 0%,transparent 70%);
  pointer-events:none;
}
...
.card::after{
  ...
  background:radial-gradient(circle,rgba(45,223,110,0.06) 0%,transparent 70%);
  pointer-events:none;
}
...
.card-logo-ring::before{
  content:'';
  position:absolute;inset:-4px;
  border-radius:50%;
  background:conic-gradient(from 0deg,var(--green),var(--green-dim),transparent,var(--green));
  animation:spin 4s linear infinite;
}

.card-logo-ring::after{
  content:'';
...
.card-logo-inner{
  ...
  border-radius:50%;
  background:linear-gradient(135deg,#0d2415,#091a0c);
  display:flex;align-items:center;justify-content:center;
  z-index:1;
  border:1px solid rgba(45,223,110,0.2);
}
...
.form-input::placeholder{color:rgba(120,180,140,0.3)}

.form-input:focus{
  border-color:var(--border-strong);
  background:rgba(45,223,110,0.04);
  box-shadow:0 0 0 3px rgba(45,223,110,0.07);
}

.form-input:focus + .field-focus-ring{opacity:1}

.form-group:focus-within .field-icon{color:var(--green)}
...
.eye-btn svg{width:16px;height:16px;stroke:currentColor;fill:none;stroke-width:1.9}
...
.check-label input:checked ~ .check-box::after{
  ...
  border-right:2px solid #03100a;
  border-bottom:2px solid #03100a;
...
.btn-login{
  width:100%;
  height:52px;
  background:linear-gradient(135deg,#2ddf6e 0%,#1a9945 100%);
  border:none;
  border-radius:14px;
  color:#021a08;
  font-family:'Syne',sans-serif;
  ...
  box-shadow:0 4px 24px rgba(45,223,110,0.28),0 1px 0 rgba(255,255,255,0.15) inset;
}
...
.btn-login:hover{
  ...
  box-shadow:0 8px 36px rgba(45,223,110,0.38);
}
.btn-login:hover::before{opacity:1}
.btn-login:active{transform:translateY(0);box-shadow:0 2px 12px rgba(45,223,110,0.2)}

.btn-login svg{width:17px;height:17px;stroke:#021a08;fill:none;stroke-width:2.5}
...
.card-foot a{color:var(--green);text-decoration:none}
...
.page-footer{
  ...
  font-size:11.5px;
  color:var(--text-dim);
  border-top:1px solid rgba(45,223,110,0.06);
}

.page-footer strong{color:var(--green-dim)}
...
@media(max-width:900px){
  ...
  .stat-item+.stat-item::before{left:-12px}
}

@media(max-width:480px){
  .hero-title{font-size:32px}
  .stats{flex-wrap:wrap;gap:16px}
  .feat-pills{display:none}
  ...
  <div class="left">
    ...
    <div class="hero">
      ...
      <div class="hero-eyebrow">
        ...
        Sistema de Gestión · RR.HH & SST
      </div>

      <h1 class="hero-title">
        Innovación<br>
        <span class="line-green">que transforma,</span><br>
        <span class="line-dim">reciclaje que</span><br>
        construye.
      </h1>

      <p class="hero-body">
        Plataforma inteligente para gestionar tu equipo humano
        y garantizar la seguridad en procesos sostenibles de
      ...
      <div class="stats">
        ...
        <div class="stat-item">
          ...
          <div class="stat-label">14001 Certificado</div>
        </div>
      </div>

      <div class="feat-pills" style="margin-top:28px">
        <div class="feat-pill"><span class="feat-pill-dot"></span>Economía circular</div>
        <div class="feat-pill"><span class="feat-pill-dot"></span>Trazabilidad en tiempo real</div>
        <div class="feat-pill"><span class="feat-pill-dot"></span>Huella de carbono</div>
        <div class="feat-pill"><span class="feat-pill-dot"></span>Reportes SST</div>
      </div>
    ...
    <div class="molecule-wrap">
      <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" fill="none">
        <!-- connector lines -->
        <line x1="200" y1="200" x2="200" y2="80" stroke="rgba(45,223,110,0.2)" stroke-width="1.5" stroke-dasharray="4 4"/>
        <line x1="200" y1="200" x2="310" y2="270" stroke="rgba(45,223,110,0.2)" stroke-width="1.5" stroke-dasharray="4 4"/>
        <line x1="200" y1="200" x2="90" y2="270" stroke="rgba(45,223,110,0.2)" stroke-width="1.5" stroke-dasharray="4 4"/>
        <line x1="200" y1="80" x2="310" y2="130" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <line x1="310" y1="130" x2="310" y2="270" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <line x1="200" y1="80" x2="90" y2="130" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <line x1="90" y1="130" x2="90" y2="270" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <line x1="90" y1="270" x2="200" y2="330" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <line x1="310" y1="270" x2="200" y2="330" stroke="rgba(45,223,110,0.1)" stroke-width="1" stroke-dasharray="3 6"/>
        <!-- outer hexagon nodes -->
        <circle cx="200" cy="80" r="14" fill="rgba(45,223,110,0.08)" stroke="rgba(45,223,110,0.4)" stroke-width="1.5"/>
        <circle cx="200" cy="80" r="6" fill="rgba(45,223,110,0.6)"/>
        <circle cx="310" cy="130" r="10" fill="rgba(45,223,110,0.06)" stroke="rgba(45,223,110,0.25)" stroke-width="1"/>
        <circle cx="310" cy="130" r="4" fill="rgba(45,223,110,0.4)"/>
        <circle cx="310" cy="270" r="14" fill="rgba(45,223,110,0.08)" stroke="rgba(45,223,110,0.4)" stroke-width="1.5"/>
        <circle cx="310" cy="270" r="6" fill="rgba(45,223,110,0.6)"/>
        <circle cx="90" cy="130" r="10" fill="rgba(45,223,110,0.06)" stroke="rgba(45,223,110,0.25)" stroke-width="1"/>
        <circle cx="90" cy="130" r="4" fill="rgba(45,223,110,0.4)"/>
        <circle cx="90" cy="270" r="14" fill="rgba(45,223,110,0.08)" stroke="rgba(45,223,110,0.4)" stroke-width="1.5"/>
        <circle cx="90" cy="270" r="6" fill="rgba(45,223,110,0.6)"/>
        <circle cx="200" cy="330" r="10" fill="rgba(45,223,110,0.06)" stroke="rgba(45,223,110,0.25)" stroke-width="1"/>
        <circle cx="200" cy="330" r="4" fill="rgba(45,223,110,0.4)"/>
        <!-- center node -->
        <circle cx="200" cy="200" r="30" fill="rgba(45,223,110,0.04)" stroke="rgba(45,223,110,0.3)" stroke-width="1.5"/>
        <circle cx="200" cy="200" r="18" fill="rgba(45,223,110,0.08)" stroke="rgba(45,223,110,0.45)" stroke-width="1"/>
        <circle cx="200" cy="200" r="8" fill="rgba(45,223,110,0.7)"/>
        <!-- orbit ring -->
        <ellipse cx="200" cy="200" rx="80" ry="30" stroke="rgba(45,223,110,0.12)" stroke-width="1" stroke-dasharray="5 8" transform="rotate(-30 200 200)"/>
        <!-- small pellet particles -->
        <circle cx="155" cy="155" r="5" fill="rgba(45,223,110,0.35)"/>
        <circle cx="248" cy="162" r="3.5" fill="rgba(45,223,110,0.25)"/>
        <circle cx="162" cy="252" r="4" fill="rgba(45,223,110,0.3)"/>
        <circle cx="245" cy="248" r="3" fill="rgba(45,223,110,0.2)"/>
      </svg>
    </div>
  ...
  <div class="right">
    <div class="card">
      ...
      <div class="card-header">
        <div class="card-logo-ring">
          <div class="card-logo-inner">
            <img src="data:image/png;base64," alt="PlastyPetco" style="width:38px;height:38px;object-fit:contain;filter:drop-shadow(0 0 8px rgba(45,223,110,0.4))"/>
          </div>
        </div>

        <h1 class="card-title">Plasty<em>Petco</em></h1>
        <p class="card-subtitle">Sistema inteligente de Recursos Humanos<br>y Seguridad en el Trabajo</p>
        <div class="card-rule"></div>
      </div>

      <!-- form -->
      <!-- Alerta JS para campos vacíos -->
      <div id="jsError" style="
        display:none;
      ...
      <?php if(isset($_GET['error'])): ?>
          <div class="error-msg" style="background:rgba(220,38,38,0.12);border:1px solid rgba(220,38,38,0.35);border-radius:12px;padding:12px 16px;font-size:13px;color:#fca5a5;margin-bottom:16px;text-align:center;">
              <?php 
                if($_GET['error'] == 1) {
                    echo "Credenciales incorrectas. Verifica tu usuario o contraseña.";
                }
              ?>
          </div>
      <?php endif; ?>
<form action="login-manual.php" method="POST">
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <input id="userField" class="form-input" type="text" name="usuario" placeholder="tu@empresa.com" autocomplete="username"/>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <input id="passField" class="form-input" type="password" name="contrasena" placeholder="••••••••" autocomplete="current-password"/>
          <button class="eye-btn" onclick="togglePass()" type="button" aria-label="Mostrar contraseña">
      ...
      <div class="meta-row">
        ...
        <a href="#" class="forgot" onclick="showForgotModal(event)">¿Olvidaste tu contraseña?</a>
      </div>

      <button class="btn-login" id="loginBtn" onclick="validarYenviar(event)">
      ...
      <div class="card-foot">
        ¿Necesitas acceso? <a href="mailto:paovf159@gmail.com?subject=Solicitud%20de%20acceso%20-%20PlastyPetco&body=Hola%2C%20necesito%20que%20me%20habiliten%20el%20acceso%20al%20sistema%20de%20gesti%C3%B3n%20de%20PlastyPetco.%0A%0ANombre%3A%20%0A%C3%81rea%3A%20%0A%0AGracias.">Contacta a tu administrador</a>
      </div>
...
<footer class="page-footer">
  <strong>PlastyPetco</strong> S.A.S &nbsp;·&nbsp; Todos los derechos reservados 2025 &nbsp;·&nbsp; Pereira, Colombia
</footer>
...
(function(){
  ...
  const COLORS=['rgba(45,223,110,','rgba(26,153,69,','rgba(100,255,150,'];
  ...
  function Particle(){
    ...
    this.pulseSpeed=.005+Math.random()*.01;
  }
    ...
    for(let i=0;i<particles.length;i++){
      for(let j=i+1;j<particles.length;j++){
        ...
        if(d<max){
          ...
          ctx.strokeStyle='rgba(45,223,110,'+(0.04*(1-d/max))+')';
          ctx.lineWidth=.6;
          ctx.stroke();
        }
      }
...
function mostrarError(msg){
  ...
  box.style.animation='shakeError .4s ease';
}

function validarYenviar(e){
  e.preventDefault();
  const usuario=document.getElementById('userField').value.trim();
  const contrasena=document.getElementById('passField').value.trim();
  const box=document.getElementById('jsError');
  ...
  // Todo bien: mostrar spinner y enviar el formulario
...
">
  <div style="
    background:linear-gradient(160deg,#0a1a0d,#061009);
    border:1px solid rgba(45,223,110,0.22);
    border-radius:24px;
    padding:40px 36px;
    max-width:380px;width:90%;
    position:relative;
    box-shadow:0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(45,223,110,0.06);
    animation:modalIn .35s cubic-bezier(.22,1,.36,1) both;
  ">
    <!-- close btn -->
    <button onclick="hideForgotModal()" style="
      position:absolute;top:16px;right:16px;
      background:rgba(255,255,255,0.06);
      border:1px solid rgba(255,255,255,0.1);
      border-radius:50%;width:32px;height:32px;
      color:#7bb891;cursor:pointer;
      display:flex;align-items:center;justify-content:center;
    ...
    <div style="
      ...
      background:rgba(45,223,110,0.08);
      border:1px solid rgba(45,223,110,0.25);
      border-radius:50%;
      display:flex;align-items:center;justify-content:center;
    ">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#2ddf6e" stroke-width="1.8">
        <rect x="3" y="11" width="18" height="11" rx="2"/>
        <path d="M7 11V7a5 5 0 0110 0v4"/>
      </svg>
    </div>

    <h3 style="font-family:'Syne',sans-serif;font-size:20px;font-weight:700;color:#fff;text-align:center;margin-bottom:10px;">¿Olvidaste tu contraseña?</h3>

    <p style="font-size:13.5px;color:#7bb891;text-align:center;line-height:1.7;margin-bottom:6px;">
      No te preocupes. Para recuperar tu acceso debes comunicarte directamente con el administrador del sistema.
    </p>

    <div style="
      background:rgba(45,223,110,0.06);
      border:1px solid rgba(45,223,110,0.15);
      border-radius:12px;
      padding:14px 16px;
      margin:20px 0;
      display:flex;align-items:center;gap:12px;
    ">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2ddf6e" stroke-width="1.8" style="flex-shrink:0">
        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
        <polyline points="22,6 12,13 2,6"/>
      </svg>
      <span style="font-size:13px;color:#d4f5e0;">paovf159@gmail.com</span>
    </div>

    <a href="mailto:paovf159@gmail.com?subject=Recuperaci%C3%B3n%20de%20contrase%C3%B1a%20-%20PlastyPetco&body=Hola%2C%20solicito%20ayuda%20para%20recuperar%20mi%20contrase%C3%B1a%20en%20el%20sistema%20PlastyPetco.%0A%0ANombre%3A%20%0A%C3%81rea%3A%20%0A%0AGracias." style="
      display:flex;align-items:center;justify-content:center;gap:8px;
      width:100%;height:48px;
      background:linear-gradient(135deg,#2ddf6e,#1a9945);
      border:none;border-radius:13px;
      color:#021a08;
      font-family:'Syne',sans-serif;font-size:14px;font-weight:700;
      text-decoration:none;
      transition:opacity .2s,transform .15s;
      box-shadow:0 4px 20px rgba(45,223,110,0.25);
    " onmouseover="this.style.opacity='.88';this.style.transform='translateY(-1px)'" onmouseout="this.style.opacity='1';this.style.transform='none'">
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#021a08" stroke-width="2.5">
        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
        <polyline points="22,6 12,13 2,6"/>
      </svg>
...
// ── RECORDARME: pre-fill usuario field from cookie
(function(){
  function getCookie(name){
    const v=document.cookie.match('(^|;)\s*'+name+'\s*=\s*([^;]+)');
    return v ? decodeURIComponent(v.pop()) : '';
  }
  const saved=getCookie('plastypetco_usuario');
  if(saved){
    const f=document.getElementById('userField');
    if(f){ f.value=saved; }
